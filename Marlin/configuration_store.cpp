...
#ifdef OutageTest
  float MarlinSettings::last_position[4];
  long MarlinSettings::last_sd_position[1];
#endif

float MarlinSettings::Current_z_offset;
float MarlinSettings::last_z_offset;
unsigned char MarlinSettings::FirstBootFlag;
  ...
  #define EEPROM_WRITE_VAR(pos, value) write_data(pos, (uint8_t*)&value, sizeof(value), &working_crc)
  #define EEPROM_READ_VAR(pos, value) read_data(pos, (uint8_t*)&value, sizeof(value), &working_crc)
...
void MarlinSettings::OutageSave() {
  char ver[4]="000";
  int j=20;
  uint16_t working_crc = 0;
...
void MarlinSettings::OutageRead() {
    int i=20;
    char stored_ver[4];
...
void MarlinSettings::SaveFirstBootFlag() {
  char ver[4]="000";
...
void MarlinSettings::readFirstBootFlag() {
...
void MarlinSettings::SaveMyZoffset() {
  char ver[4]="000";
...
void MarlinSettings::ReadMyZoffset() {
