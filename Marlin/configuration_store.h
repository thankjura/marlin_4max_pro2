...
class MarlinSettings {
  public:
    ...
    #ifdef OutageTest
      static void OutageSave();
      static void OutageRead();
      static float last_position[4];
      static long last_sd_position[1];
    #endif

    static void SaveMyZoffset();
    static void ReadMyZoffset();
    static float Current_z_offset;
    //extern float last_z_offset[1];
    static float last_z_offset;
    static unsigned char FirstBootFlag;
    static void SaveFirstBootFlag();
    static void readFirstBootFlag();
